<?php 
	...
	if (isset($_POST['_action_']) && $_POST['_action_'] == 'add_news') {
        ...
        if($_FILES['picture']['error'] == UPLOAD_ERR_OK && $_FILES['picture']['name'] != "") {
			...
			if ($ext == '.jpeg' || $ext == '.png' || $ext == '.gif' || $ext == '.jpg') { # test if format is picture
		...
		$_SESSION['message'] .= '<p>Uspješno ste dodali novosti!</p>';
	...
	if (isset($_POST['_action_']) && $_POST['_action_'] == 'edit_news') {
		...
		$_SESSION['message'] = '<p>Uspješno ste promijenili novosti!</p>';
	...
	if (isset($_GET['delete']) && $_GET['delete'] != '') {
		...
		$_SESSION['message'] = '<p>Uspješno ste obrisali novosti!</p>';
	...
	#Add news 
		...
		<form action="" id="news_form" name="news_form" method="POST" enctype="multipart/form-data">
			...
			<input type="text" id="title" name="title" placeholder="Naslov novosti.." required>
	...
	#Edit news
		...
		<form action="" id="news_form_edit" name="news_form_edit" method="POST" enctype="multipart/form-data">
			...
			<label for="title">Naslov *</label>
			<input type="text" id="title" name="title" value="' . $row['title'] . '" placeholder="Naslov novosti.." required>
